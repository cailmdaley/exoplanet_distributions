...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\linewidth]{solar_mass_detections}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\linewidth]{intrinsic_dist}
...
\begin{figure}
  ...
  \includegraphics[width=\linewidth]{long_P_no_fold}
  \end{subfigure}
  \begin{subfigure}[b]{.45\linewidth}
  \includegraphics[width=\linewidth]{short_P_no_fold}
  \end{subfigure}
  
  
  \begin{subfigure}[b]{.45\linewidth}
  \includegraphics[width=\linewidth]{long_P_folded}
  \end{subfigure}
  \begin{subfigure}[b]{.45\linewidth}
  \includegraphics[width=\linewidth]{short_P_folded}
  \end{subfigure}
...
\begin{figure}[h]
  ...
  \begin{subfigure}[b]{.45\linewidth}
  \includegraphics[width=\linewidth]{planets2_intrinsic_dist}
  \end{subfigure}
  \begin{subfigure}[b]{.45\linewidth}
  \includegraphics[width=\linewidth]{planets2_observed_dist}
  \end{subfigure}
